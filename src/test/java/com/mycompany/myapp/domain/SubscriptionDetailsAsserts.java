...
public class SubscriptionDetailsAsserts {
    ...
    public static void assertSubscriptionDetailsUpdatableFieldsEquals(SubscriptionDetails expected, SubscriptionDetails actual) {
        assertThat(expected)
            ...
            .satisfies(e -> assertThat(e.getSubscriptionAmount()).as("check subscriptionAmount").isEqualTo(actual.getSubscriptionAmount()))
            .satisfies(e -> assertThat(e.getTaxAmount()).as("check taxAmount").isEqualTo(actual.getTaxAmount()))
